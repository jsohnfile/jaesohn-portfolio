                ...
                <div className="portfolio__projectContainer">
                    ...
                    <div className="portfolio__project" >
                        ...
                        <div className="portfolio__container">
                            ...
                            <div className="portfolio__projectWrapper">
                                <Project glink="https://github.com/jsohnfile/sharecipe" plink="https://sharecipe-recipeshare.herokuapp.com" image="https://i.imgur.com/9g9zvuS.jpg" title="Sharecipe" textOne="Having a passion for cooking and testing out new recipes, this app was developed to give users the ability to create, share, and favorite reipes with users of the Sharecipe Community" textTwo="Technologies Used: HTML, CSS, JavaScript, NodeJS, ExpressJS, Mongoose/MongoDB, EJS"/>
                            </div>
                            <div className="portfolio__projectWrapper">
